...
//               Health and life insurance are essential financial tools that provide protection against medical expenses and ensure financial security for your loved ones. These policies help you manage healthcare costs and provide a financial safety net for your family in case of unfortunate events.
//             </p>
//           </div>
//           <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
//             <div>
...
//                     text: "Covers healthcare expenses and protects your savings from being depleted due to medical emergencies.",
//                   },
//                   {
//                     title: "Financial Protection:",
//                     text: "Ensures your family's financial security and helps them maintain their lifestyle even in your absence.",
//                   },
//                   {
//                     title: "Tax Benfits:",
//                     text: "Provides tax advantages under various sections of the Income Tax Act.",
//                   },
//                   {
//                     title: "Peace of Mind:",
//                     text: "Offers reassurance that you and your loved ones are protected against life's uncertainties",
//                   },
//                 ].map((item, idx) => (
...
//                   {[
//                     {
//                       icon: <Hospital className="h-10 w-10 text-blue-700 mb-2" />,
//                       title: "Hospitalization Coverage",
//                       desc: "Covers in-patient hospitalization expenses including room charges, doctor fees, surgery costs, and medication during hospital stays.",
//                     },
//                     {
//                       icon: <Stethoscope className="h-10 w-10 text-blue-700 mb-2" />,
//                       title: "Pre & Post Hospitalization",
//                       desc: "Covers medical expenses incurred before and after hospitalization, including diagnostic tests, medications, and follow-up consultations.",
//                     },
//                     {
//                       icon: <Activity className="h-10 w-10 text-blue-700 mb-2" />,
//                       title: "Critical Illness Coverage",
//                       desc: "Provides lump-sum benefits upon diagnosis of specified critical illnesses, helping manage treatment costs and income loss during recovery.",
//                     },
//                     {
//                       icon: <Shield className="h-10 w-10 text-blue-700 mb-2" />,
//                       title: "Financial Security",
//                       desc: "Life insurance provides a financial safety net for your family, ensuring they can maintain their lifestyle and meet financial obligations.",
//                     },
//                     {
//                       icon: <DollarSign className="h-10 w-10 text-blue-700 mb-2" />,
//                       title: "Tax Benefits",
//                       desc: "Premiums paid for health and life insurance policies qualify for tax deductions under Section 80D and 80C of the Income Tax Act, respectively.",
//                     },
//                     {
//                       icon: <Leaf className="h-10 w-10 text-blue-700 mb-2" />,
//                       title: "Wealth Creation",
//                       desc: "Certain life insurance policies like ULIPs and endowment plans offer investment opportunities, combining insurance protection with wealth accumulation.",
//                     },
//                   ].map((benefit, idx) => (
//                     <div
//                       key={idx}
