...
//     emailjs.sendForm(
//       'service_rq7zh28',         // Your EmailJS service ID
//       'template_5ovk5i9',    // Your new EmailJS template ID
//       formRef.current,
//       'X3pllJfNycUENYC78'        // Your EmailJS Public Key
//     ).then(
//       (result) => {
//         alert('Advisor form submitted successfully!');
...
//   return (
//     <div className="bg-white min-h-screen pt-24 px-6 md:px-20">
//       <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-10 items-center">

//         {/* LEFT: Impactful Text Section */}
//         <div className="space-y-10">
//           <h1 className="text-6xl font-extrabold text-blue-800 leading-tight tracking-tight">
//             Be the Change.<br />Lead with Purpose.<br />Become an Advisor.
//           </h1>
//           <p className="text-gray-800 text-2xl leading-9">
...
//           </p>
//           <ul className="space-y-6 text-gray-900 text-xl pl-6 list-disc">
...
//         {/* RIGHT: Form Section */}
//         <div className="bg-gray-100 shadow-2xl p-12 rounded-3xl border-t-8 border-blue-700">
//           <h2 className="text-4xl font-bold text-blue-800 mb-10">Join the Advisor Network</h2>
//           <form ref={formRef} onSubmit={sendEmail} className="space-y-8 text-lg">
//             <div>
//               <label className="block mb-3 font-semibold text-gray-700 text-xl">Full Name</label>
//               <input
//                 type="text"
//                 name="user_name"
//                 required
...
//             </div>
//             <div>
//               <label className="block mb-3 font-semibold text-gray-700 text-xl">Email Address</label>
//               <input
//                 type="email"
//                 name="user_email"
//                 required
...
//             </div>
//             <div>
//               <label className="block mb-3 font-semibold text-gray-700 text-xl">Mobile Number</label>
//               <input
//                 type="tel"
//                 name="user_phone"
//                 required
...
//             <button
//               type="submit"
//               className="w-full bg-blue-700 text-white text-2xl font-bold py-4 rounded-full hover:bg-blue-800 transition-all"
//             >
//               Become an Advisor
//             </button>
//           </form>
