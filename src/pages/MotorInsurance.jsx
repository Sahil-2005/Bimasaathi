            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-lg md:text-xl mb-6">
                  Coverage to protect your vehicle and give you peace of mind on
                  the road.
                </p>
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="max-w-3xl mx-auto text-center mb-12">
              ...
              <p className="text-gray-700 text-lg">
                Motor insurance is a contract between you and the insurance
                company that protects you against financial loss in the event of
                an accident or theft. In exchange for your paying a premium, the
                insurance company agrees to pay your losses as outlined in your
                policy.
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                {
                  icon: (
                    <AlertCircle className="h-10 w-10 text-blue-700 mb-2" />
                  ),
          ...
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="border border-blue-100 rounded-lg p-6 hover:shadow-md transition-shadow">
                ...
                <h3 className="text-xl text-center text-blue-700 font-semibold mb-4">
                  Car Insurance
                </h3>
                <p className="text-gray-700 text-center mb-4">
                  Comprehensive coverage for personal cars, sedans, SUVs, and
                  family vehicles.
                </p>
              ...
              <div className="border border-blue-100 rounded-lg p-6 hover:shadow-md transition-shadow">
                ...
                <p className="text-gray-700 text-center mb-4">
                  Insurance for motorcycles, scooters, and bikes with coverage
                  for theft, damage, and third-party liability.
                </p>
                <ul className="space-y-2">
                  {[
              ...
              <div className="border border-blue-100 rounded-lg p-6 hover:shadow-md transition-shadow">
                ...
                <p className="text-gray-700 text-center mb-4">
                  Designed for trucks, vans, taxis, and commercial fleets.
                  Offers liability and comprehensive protection.
                </p>
                <ul className="space-y-2">
                  {[
              ...
              <div className="border border-blue-100 rounded-lg p-6 hover:shadow-md transition-shadow">
                <div className="flex justify-center mb-4">
                  <Bus className="h-16 w-16 text-blue-700" />
                </div>
                <h3 className="text-xl text-center text-blue-700 font-semibold mb-4">
                  PCV Insurance
                </h3>
                <p className="text-gray-700 text-center mb-4">
                  Insurance tailored for passenger-carrying vehicles like taxis,
                  auto-rickshaws, buses, and minibuses.
                </p>
                <ul className="space-y-2">
                  {[
                    "Covers passengers and third-party liabilities",
                    "Protection for driver and vehicle damage",
                    "Compliance with transport authority norms",
                  ].map((feature, idx) => (
                    <li key={idx} className="flex items-start gap-2">
                      <CheckCircle className="h-5 w-5 text-blue-700 flex-shrink-0 mt-0.5" />
                      <span className="text-gray-700">{feature}</span>
