...
//                   <div>
//                     <h1 className="text-3xl md:text-5xl font-bold mb-4">Home Insurance Protection</h1>
...
//             <h2 className="text-3xl font-bold text-blue-700 mb-4">What is Home Insurance?</h2>
...
//                         {[
//                           {
//                             icon: <Building className="h-10 w-10 text-blue-700 mb-2" />,
...
//                           },
//                           {
//                             icon: <Sofa className="h-10 w-10 text-blue-700 mb-2" />,
...
//                           },
//                           {
//                             icon: <HomeIcon className="h-10 w-10 text-blue-700 mb-2" />,
