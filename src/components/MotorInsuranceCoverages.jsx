...
//       className="w-full text-left px-6 py-4 hover:bg-blue-50 text-blue-600 font-medium focus:outline-none"
//     >
//       {title}
//     </button>
...
//                 <span className="text-gray-700">Bodily injury liability: Covers medical expenses, lost wages, and legal fees</span>
//               </li>
//               <li className="flex items-start gap-2">
//                 <CheckCircle className="h-5 w-5 text-blue-600 mt-0.5" />
//                 <span className="text-gray-700">Property damage liability: Covers repair or replacement of others' property</span>
//               </li>
//             </ul>
//           </div>
//           <div>
//             <img src="/placeholder.svg" alt="Liability Coverage" width={200} height={150} className="rounded-lg" />
//           </div>
//         </div>
//       ),
//     },
...
//             </p>
//             <ul className="space-y-2">
//               {['Repairs to your vehicle after an accident', 'Replacement if your vehicle is totaled', 'Coverage for single-car accidents like rollovers'].map((text, i) => (
...
//           </div>
//           <div>
//             <img src="/placeholder.svg" alt="Collision Coverage" width={200} height={150} className="rounded-lg" />
//           </div>
//         </div>
//       ),
//     },
...
//             </p>
//             <ul className="space-y-2">
//               {['Theft or attempted theft', 'Vandalism and riots', 'Fire damage', 'Natural disasters (floods, earthquakes, hail)', 'Falling objects', 'Animal collisions'].map((text, i) => (
//                 <li key={i} className="flex items-start gap-2">
//                   <CheckCircle className="h-5 w-5 text-blue-600 mt-0.5" />
//                   <span className="text-gray-700">{text}</span>
//                 </li>
...
//           </div>
//           <div>
//             <img src="/placeholder.svg" alt="Comprehensive Coverage" width={200} height={150} className="rounded-lg" />
//           </div>
//         </div>
//       ),
//     },
...
//             </p>
//             <ul className="space-y-2">
//               {['Medical expenses', 'Lost wages', 'Rehabilitation costs', 'Funeral expenses', 'Replacement services (like childcare)'].map((text, i) => (
//                 <li key={i} className="flex items-start gap-2">
//                   <CheckCircle className="h-5 w-5 text-blue-600 mt-0.5" />
//                   <span className="text-gray-700">{text}</span>
//                 </li>
...
//           </div>
//           <div>
//             <img src="/placeholder.svg" alt="Personal Injury Protection" width={200} height={150} className="rounded-lg" />
//           </div>
//         </div>
//       ),
//     },
...
//             </p>
//             <ul className="space-y-2">
//               {['Medical expenses', 'Lost wages', 'Pain and suffering', 'Property damage (in some states)'].map((text, i) => (
//                 <li key={i} className="flex items-start gap-2">
//                   <CheckCircle className="h-5 w-5 text-blue-600 mt-0.5" />
//                   <span className="text-gray-700">{text}</span>
//                 </li>
...
//           </div>
//           <div>
//             <img src="/placeholder.svg" alt="Uninsured Motorist Coverage" width={200} height={150} className="rounded-lg" />
//           </div>
//         </div>
//       ),
//     },
...
//             </p>
//             <ul className="space-y-2">
//               {['Roadside assistance', 'Rental car reimbursement', 'Gap insurance', 'New car replacement', 'Custom parts and equipment coverage', 'Mechanical breakdown insurance'].map((text, i) => (
//                 <li key={i} className="flex items-start gap-2">
//                   <CheckCircle className="h-5 w-5 text-blue-600 mt-0.5" />
//                   <span className="text-gray-700">{text}</span>
//                 </li>
...
//           </div>
//           <div>
//             <img src="/placeholder.svg" alt="Add-on Coverages" width={200} height={150} className="rounded-lg" />
//           </div>
//         </div>
//       ),
//     },
...
//         <h2 className="text-3xl font-bold text-blue-600 text-center mb-12">Types of Coverages in Motor Insurance</h2>
