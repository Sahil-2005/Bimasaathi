...
//             General.
//             <br />
//             CIN: U123456GJ2023PTC123456
//             <br />
//             IRDAI Reg No: 987 | Valid till 10/12/2026
//           </p>

//           <button className="mt-4 px-5 py-3 bg-white text-blue-900 text-base sm:text-lg font-semibold rounded-xl hover:bg-blue-100 transition duration-300">
//           <Link
//           to="/be-advisor"
//           // className="mt-4 px-5 py-3 bg-white text-blue-900 text-base sm:text-lg font-semibold rounded-xl hover:bg-blue-100 transition duration-300"
//         >
//           Become an Advisor
//         </Link>
//             {/* Become an Advisor */}
...
//               <br />
//               Ghatkopar (West) Opp. Shreyas Cinema Mumbai - 400086
//             </p>
//           </div>
//           <div className="text-base sm:text-lg opacity-90">
//             📞 +91 75748 55550
//             <br />
//             📧 support@bimasaathi.in
//           </div>
//         </motion.div>
//       </div>

//       {/* Bottom Bar */}
//       <div className="mt-14 border-t border-blue-600 pt-6 text-base sm:text-lg flex flex-col sm:flex-row justify-between items-center gap-4 sm:gap-0 w-full max-w-[1600px] mx-auto">
//         <p>© {new Date().getFullYear()} Bimasaathi. All rights reserved.</p>
